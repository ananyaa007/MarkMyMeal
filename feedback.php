        ...
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              ...
              <h5 class="card-title">Send Us Your Feedback!</h5>
              ...
              <div class="form-left">
                ...
                <form class="row g-3">
                  ...
                  <div class="col-8">
                    <label class="col-sm-8 col-form-label">How was the food?</label>
                  ...
                  <div class="col-8">
                    <label class="col-sm-8 col-form-label">Do you have any suggestion?</label>
                    <div class="col-sm-12">
